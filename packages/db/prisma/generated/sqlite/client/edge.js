...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/gin/lib/twona/packages/db/prisma/generated/sqlite/client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineSchemaHash": "338ea32e98a1d937133df66799fbe7fcf9496c17846084e80ce3ae4611688f6e",
  "copyEngine": true
}
config.dirname = '/'
...
config.injectableEdgeEnv = () => ({
  parsed: {
    SL_DATABASE_URL: typeof globalThis !== 'undefined' && globalThis['SL_DATABASE_URL'] || typeof process !== 'undefined' && process.env && process.env.SL_DATABASE_URL || undefined
  }
})
